    ...
    if (sse_fn_epp == SSE_SPECIAL) {
            ...
            if (b1) {
                ...
                if (mod == 3) {
                    ...
                    case 0x22: case 0x32: /* pmovsxbq, pmovzxbq */
                        tcg_gen_qsim_ld_tl(cpu_tmp0, cpu_A0,
                                           s->mem_index, MO_LEUW);
        ...
        do_0f_38_fx:
            ...
            case 0x0f1: /* movbe My,Gy */
                ...
                gen_lea_modrm(env, s, modrm);
                if ((b & 1) == 0) {
                    tcg_gen_qsim_ld_tl(cpu_T[0], cpu_A0,
                                       s->mem_index, ot | MO_BE);
                    gen_op_mov_reg_v(ot, reg, cpu_T[0]);
                } else {
                    tcg_gen_qsim_st_tl(cpu_regs[reg], cpu_A0,
                                       s->mem_index, ot | MO_BE);
                }
                break;
            ...
            if (sse_fn_eppi == SSE_SPECIAL) {
                ...
                case 0x14: /* pextrb */
                    ...
                    if (mod == 3) {
                        ...
                        tcg_gen_qsim_st_tl(cpu_T[0], cpu_A0,
                                           s->mem_index, MO_UB);
                    }
                    break;
                case 0x15: /* pextrw */
 ...
 reswitch:
    ...
    case 0xf7:
        ...
        case 6: /* div */
            ...
            switch(ot) {
            case MO_8:
                QSIM_REG_READ(X86_REG_RAX, 1);
                QSIM_REG_READ(X86_REG_RDX, 1);
                gen_jmp_im(pc_start - s->cs_base);
                gen_helper_divb_AL(cpu_env, cpu_T[0]);
                QSIM_REG_WRITE(X86_REG_RAX, 1);
                QSIM_REG_WRITE(X86_REG_RDX, 1);
                break;
            case MO_16:
                QSIM_REG_READ(X86_REG_RAX, 2);
                QSIM_REG_READ(X86_REG_RDX, 2);
                gen_jmp_im(pc_start - s->cs_base);
                gen_helper_divw_AX(cpu_env, cpu_T[0]);
                QSIM_REG_WRITE(X86_REG_RAX, 2);
                QSIM_REG_WRITE(X86_REG_RDX, 2);
                break;
            default:
            case MO_32:
                QSIM_REG_READ(X86_REG_RAX, 4);
                QSIM_REG_READ(X86_REG_RDX, 4);
                gen_jmp_im(pc_start - s->cs_base);
                gen_helper_divl_EAX(cpu_env, cpu_T[0]);
                QSIM_REG_WRITE(X86_REG_RAX, 4);
                QSIM_REG_WRITE(X86_REG_RDX, 4);
                break;
#ifdef TARGET_X86_64
            case MO_64:
                QSIM_REG_READ(X86_REG_RAX, 8);
                QSIM_REG_READ(X86_REG_RDX, 8);
                gen_jmp_im(pc_start - s->cs_base);
                gen_helper_divq_EAX(cpu_env, cpu_T[0]);
                QSIM_REG_WRITE(X86_REG_RAX, 8);
                QSIM_REG_WRITE(X86_REG_RDX, 8);
                break;
#endif
            }
            break;
